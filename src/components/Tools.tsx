...
const Tools = () => {
  ...
  return (
    <div className="md:my-24 rounded-2xl mx-5 md:mx-4 lg:mx-8 bg-[#18173B] text-start p-6">
      <h2 className="text-xl">Tools</h2>

      <div className="mt-2">
        <span className="text-base font-extralight mx-auto">
          My primary stack includes Go, Svelte, Next.js and PostgreSQL. Some of
          the languages, frameworks, libraries, applications and software tools
          I use/used include:
        </span>
      </div>
